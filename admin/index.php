 ...
 <section class="content charts-section">
    <div class="container my-3">
        ...
        <div class="row" id="count">
            <div class="col-md-4">
                <a class="card-link" href="<?php echo SROOT."/admin/rooms.php"; ?>">
            ...
            <div class="col-md-4">
                <a class="card-link" href="<?php echo SROOT."/admin/users.php"; ?>">
            ...
            <div class="col-md-4">
                <a class="card-link" href="<?php echo SROOT."/admin/reservation.php"; ?>">
