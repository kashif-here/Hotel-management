            ...
            <div class="card">
              ...
              <div class="card-footer">
                <div class="footer-head">
                  ...
                  <div class="price">Rs.1350/day</div>
                </div>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="content">
              ...
              <p>
                Discover rooms that match your budget and style, from cozy
                singles to luxury suites. Clear pricing, flexible dates, and
                modern amenities make planning your stay simple and stress free.
              </p>
            </div>
          </div>
          <div class="col-md-7 card-container">
            <div class="card">
              <div class="card-body">
                <img src="./media/images/backgrounds/pic.jpg" alt="" />
              </div>
              <div class="card-footer">Hotel Exterior</div>
            </div>
            <div class="card">
              <div class="card-body">
                <img src="./media/images/backgrounds/picc.jpg" alt="" />
              </div>
              <div class="card-footer">Hotel Interior</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <div class="content">
              ...
              <p>
                Enjoy exclusive offers on premium rooms with added comfort and
                complimentary services. Book early and save more on longer stays
